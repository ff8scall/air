...
export default function HeroStatusCard({ data, stationName, regionName }: Props) {
  ...
  const bgGradient: Record<string, string> = {
    "좋음": "from-sky-400 to-blue-500",
    "보통": "from-emerald-400 to-green-500",
    "나쁨": "from-orange-400 to-amber-500",
    "매우나쁨": "from-red-500 to-rose-600",
    "알 수 없음": "from-gray-400 to-slate-500",
  };
      ...
      <div className="relative z-10 p-6 md:p-8">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          ...
          <div className="bg-white/15 backdrop-blur rounded-2xl p-4">
            <p className="text-white/60 text-xs font-semibold uppercase tracking-wide mb-1">PM10 미세먼지</p>
          ...
          {/* PM2.5 */}
          <div className="bg-white/15 backdrop-blur rounded-2xl p-4">
            <p className="text-white/60 text-xs font-semibold uppercase tracking-wide mb-1">PM2.5 초미세먼지</p>
            <div className="flex items-baseline gap-1">
